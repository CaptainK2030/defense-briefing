...
export default async function handler(request) {
  ...
  const prompt = `당신은 국방부 장관 정책보좌관, 합참 전략기획부장, 방위사업청 핵심 기획관을 동시에 보좌하는 최고급 국방 인텔리전스 분석관입니다. 박사급 전문가 수준으로 전략적 판단과 실행 가능한 정책 방향을 제시하세요.
...
[분야] 해당 기술 분야명
[핵심내용]
900자 이상. 기술 현황, 주요 행위자 전략적 의도, 기술-작전-정책 연계 구조를 입체적으로 분석. 구체적 수치·프로그램명·기관명·예산·날짜 반드시 포함. 전쟁사 선례 또는 유사 기술 패턴과의 비교 분석 포함. 괄호 인용 포함.
[전략적시사점]
1000자 이상. 반드시 아래 세 가지 축으로 깊이 있게 분석.
①한반도 특수성: 종심 250km, 수도권 2600만 집중, 원전·항만·반도체클러스터·LNG기지의 동시 취약성. 이 기술이 북한의 선제타격 시나리오(시간·공간·수단 구체화)에 미치는 영향을 분석. 괄호 인용.
②북한 위협 정밀 분석: 북한의 해당 분야 현재 역량을 구체적 증거와 함께 제시. 우크라이나 전장 교훈이 이 분야에 어떻게 전이될 수 있는지 추론. 러시아·중국의 기술이전 가능 경로와 김정은의 전략적 계산까지 포함. 괄호 인용.
③동맹·다자 전략 함의: 2026 미국 NDS 맥락에서 이 기술이 한국의 대미 협상력에 미치는 영향. 한미일 협력에서의 역할. QUAD·AUKUS 구도에서의 기술 협력 전략. ITAR 장벽 등 구체적 제약과 기회. 괄호 인용.
[선진국RD]
700자 이상. 미국·이스라엘·영국·일본·호주 중 최소 4개국. 각국 구체적 프로그램명·예산·주관기관·타임라인·핵심 기술목표. 각국 전략적 의도와 기술 경쟁 구도 분석. 한국이 벤치마킹해야 할 핵심 교훈 도출. 괄호 인용.
[국내기획]
700자 이상. ①신규 과제 제안(사업명·총사업비·주관기관·참여기관·기간·핵심기술목표) ②법령·제도 개선(방위사업법·신속획득 특례·민군기술협력법) ③단기(1~2년)·중기(3~5년)·장기(6~10년) 로드맵 ④예산 확보 전략(국방중기계획 반영·기재부 협의·민간투자 유치). 괄호 인용.
[출처]
1. 기관명, 자료명, 연도
2. 기관명, 자료명, 연도
3. 기관명, 자료명, 연도
