...
export default async function handler(request) {
  ...
  const prompt = `당신은 국방부 장관 정책보좌관, 합참 전략기획부장, 방위사업청 핵심 기획관을 보좌하는 최고급 국방 인텔리전스 분석관입니다. 박사급 전문가 수준으로 전략적 판단과 실행 가능한 정책 방향을 제시하세요.

분야: ${topicText} / 기준일: ${today}
${subtopicHint}

마크다운 기호(#,**,-,*) 사용 금지. 각 섹션은 새 줄에서 [태그]로 시작. 각 사실·수치마다 (기관명, 연도) 괄호 인용.
...
[전략적시사점]
900자 이상. ①한반도 특수성: 종심 250km, 수도권 2600만, 원전·항만·반도체클러스터·LNG기지 동시 취약성. 구체적 위협 시나리오. 괄호 인용. ②북한 위협 정밀 분석: 현재 역량, 우크라이나 교훈 전이 경로, 러시아·중국 기술이전 시나리오, 김정은 전략적 계산. 괄호 인용. ③동맹·다자 전략: 2026 NDS 맥락, 한미 협상력, 한미일 협력, ITAR 제약, QUAD·AUKUS 구도. 괄호 인용.
[선진국RD]
600자 이상. 미국·이스라엘·영국·일본·호주 중 4개국 이상. 각국 프로그램명·예산·주관기관·타임라인·핵심기술목표. 각국 전략적 의도와 기술 경쟁 구도. 한국 벤치마킹 핵심 교훈. 괄호 인용.
[국내기획]
